...
然而， 新弗式的万能代码功能， 将不只是虚无的幻想， 而是能够以一行又一行的代码实现的现实。 万能代码最重要功能， 是除了统一所有编程语言以外， 还能作为所有数学符号和函数的代码。 这件事， 对于广大学生群众学习数学， 有极大的重要意义， 因为有了代表所有数学符号和函数的代码， 最复杂深奥的数学公式都能化繁为简， 深入浅出， 让学生把复杂的公式， 分解成简单的步骤， 按部就班掌握数学公式。 就像当年有了计算机， 数据计算的工作就简化了许多， 使得多数人都能掌握并进行复杂的数据运算。 万能数学代码的功能， 能使更多的学生和大众， 掌握复杂抽象的数学公式， 可以造就飞跃式的新一代数理人才， 对人类一切知识领域的贡献， 无可限量。
